        # Rmstnma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/rmstnma.git

        ## Objective

        RMSTNMA combines restricted mean survival time (RMST) endpoints with network meta-analysis, enabling comparative effectiveness synthesis using time-to-event data.
        ...
        - Code: https://github.com/mahmood726-cyber/rmstnma.git
        - Dashboard: https://mahmood726-cyber.github.io/rmstnma/
